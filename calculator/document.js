document.addEventListener('DOMContentLoaded', function () {
    ...
    let isSpeaking = false; // Change the initial state to false

    // Create a variable to hold the current speech synthesis utterance
    let currentUtterance = null;

    // Create a variable to store the position where speech synthesis was paused
    let pausePosition = 0;
